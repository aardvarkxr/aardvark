...
void CAardvarkCefApp::OnContextInitialized()
{
	...
	startGadget( "http://aardvark.install/gadgets/aardvark_master", "", aardvark::EndpointAddr_t() );
}
	...
	const aardvark::EndpointAddr_t & epToNotify )
{
	...
	CefRefPtr<CAardvarkCefHandler> handler( new CAardvarkCefHandler( this, uri, initialHook, epToNotify ) );
