...
namespace aardvark
{
	::kj::Promise<void> AvPokerProcessorImpl::updatePanelProximity( UpdatePanelProximityContext context ) 
	{
	...
	EAvSceneGraphResult AvPokerProcessorImpl::avGetNextPokerProximity( uint32_t pokerNodeId,
