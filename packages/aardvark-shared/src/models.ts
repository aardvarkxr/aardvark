...
export const g_builtinModelBackfacedSphere = g_builtinModelPrefix + "sphere/sphere_backfaced.glb";
...
export const g_builtinModelToolbox = g_builtinModelPrefix + "toolbox.glb";
