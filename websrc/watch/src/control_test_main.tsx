...
import { AvTransform, AvSlider, AvGrabbable, AvSphereHandle, AvModel, AvPanel, AvPanelAnchor, AvTransformControl, AvNodeTransform, QuaternionToEulerAngles, RadiansToDegrees } from 'aardvark-react';
			...
			<div className="FullPage" >
				<AvGrabbable preserveDropTransform={true}>
					<AvTransform uniformScale={0.1}>
						<AvModel uri="https://aardvark.install/models/watch.glb"/>
					</AvTransform>
								...
								<div className="SliderControl">
									<AvPanelAnchor>
										<AvSlider rangeX={ 0.7 } onSetValue={ this.onSetSlider }
											modelUri="https://aardvark.install/models/watch.glb"/>
									</AvPanelAnchor>
								</div>
							</div>
